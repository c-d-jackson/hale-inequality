...
* set our own mortality_root global
global mortality_root "/Users/cdjack/Dropbox/work/stanford/projects/hartford_state_v3plus/03_hale_inequality/data/chetty2016"
do "${mortality_root}/code/set_environment.do"
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *
...
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *
* We do not need to create these folders.
...
* Modify code for "State by Gender x Income Quartile x Year" 
forvalues i = 40/80 {
	di "calculations for age `i'"
	* State by Gender x Income Quartile x Year
	generate_le_with_raceadj, by(st gnd hh_inc_q year) maxage_gomp_parameterfit(63) ///
		le_age(`i') /// add argument for age
		gomporiginal gompparameters("$derived/Gompertz Parameters/st_gompBY_gnd_hhincquartile_year.dta") ///
		raceshares("$derived/raceshares/st_racesharesBY_year_agebin_gnd_hhincquartile.dta") ///
		saving("$derived/le_estimates/st_le`i'BY_year_gnd_hhincquartile.dta")  // add specific age to filename
}
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *
